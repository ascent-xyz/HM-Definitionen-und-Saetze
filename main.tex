...
Dann ist \(\eval{\d f}_{x=x^{(0)}} = \mathcal{A}\). %Fehlt hier möglicherweiße noch ein der unter Teil des Ableitungsoperators?
}
...
\dfn{}{
\(f_n \overset{n \to \infty}{\rightrightarrows} f\) gleichmäßig bzgl. \(x \in I\) genau dann, wenn %Zwie übereinanderliegende Pfeile?
